...
while driver.step() != -1:
    ...
    # Track if the user is actively steering during this step
    is_steering = False 
    ...
    # --- NEW: Recenter the wheels if no steering keys are pressed ---
    if useManual and not is_steering:
        # angle = 0  # Wheels instantly snap back to straight
        
        # NOTE: If you want the steering wheel to smoothly glide back to the center 
        # instead of snapping instantly, use this instead:
        angle /= 1.5 
    # ----------------------------------------------------------------
